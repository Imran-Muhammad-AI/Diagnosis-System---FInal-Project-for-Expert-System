...
def if_not_matched(disease):
        ...
        print("")
        print("The disease that you mihgt have is %s\n" %(id_disease))
        print("Description of the disease is asfollows :\n")
...
class Greetings(KnowledgeEngine):
    ...
    def _initial_action(self):
        print("")
        print("Hi! I am Dr.Expert, ")
        print("You'll have to answer a few questions about your conditions")
